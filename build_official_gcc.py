...
BUILD_DIR = r"D:\radio px\keil_project\build_gcc"
TARGET = "firmware"
...
def main():
    ...
    print("[1/5] Compilando arquivos C do projeto oficial...")
    ...
    print("[2/5] Compilando arquivo Assembly de inicializacao...")
    ...
    print("[3/5] Linkando firmware.elf sem limite de tamanho...")
    ...
    out_final = r"D:\radio px\RT900_MAIESQUE_DESBLOQUEADO.BTU"
    if os.path.exists(btu_src):
        ...
        # Tentar procurar na pasta raiz
        btus = glob.glob(r"D:\radio px\*.btu") + glob.glob(r"D:\radio px\rt900\*.btu")
